...
export const metadata: Metadata = {
  title: "Laminated Chipboard | NORDECO Designs",
  description: "Cost-effective melamine-faced chipboard panels ideal for cabinetry, shelving, and commercial interiors. Wide décor selection available.",
}

const specifications = [
  { label: "Thickness", value: "8mm, 12mm, 15mm, 18mm, 22mm, 25mm" },
  { label: "Standard Sizes", value: "2440 x 1220mm, 2800 x 2070mm, 3660 x 1830mm" },
  { label: "Core Material", value: "Particle board (620-680 kg/m³)" },
  { label: "Surface Finish", value: "Melamine paper, various textures" },
  { label: "Emission Class", value: "E0.5 (Ultra-low formaldehyde)" },
  { label: "Edge Options", value: "Raw, pre-glued ABS, matching PVC" },
]
...
const features = [
  ...
  "Wide range of décor finishes",
  "Good dimensional stability",
  "Suitable for flatpack furniture",
  "Easy to cut and process",
  "Consistent quality across batches",
]

export default function LaminatedChipboardPage() {
  return (
    <>
      {/* Hero */}
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-primary-foreground/80">
                Cost-effective melamine-faced particle board offering excellent value for commercial and residential furniture applications. Available in a comprehensive range of décors to suit any design requirement.
              </p>
            ...
            <div className="relative aspect-square overflow-hidden rounded-lg">
              <Image
                src="/images/laminated-chipboard.jpg"
                alt="Laminated chipboard panel"
                fill
