...
export const metadata: Metadata = {
  title: "Particle Board | NORDECO Designs",
  description: "Engineered wood panels for structural applications and substrate requirements. Cost-effective solution for furniture and construction.",
}

const specifications = [
  { label: "Thickness", value: "8mm, 12mm, 15mm, 18mm, 22mm, 25mm, 28mm, 38mm" },
  { label: "Standard Sizes", value: "2440 x 1220mm, 2800 x 2070mm, 3660 x 1830mm" },
  { label: "Density", value: "620-680 kg/m³" },
  { label: "Surface Quality", value: "Sanded both sides" },
  { label: "Emission Class", value: "E0.5 (Ultra-low formaldehyde)" },
  { label: "Grades", value: "Standard, Moisture Resistant (P3), Heavy Duty (P5)" },
]

const applications = [
  "Furniture core and substrates",
...
const features = [
  ...
  "Suitable for laminating and veneering",
  "Consistent quality",
  "Large format sheets available",
]
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-primary-foreground/80">
                Engineered wood panels manufactured from wood particles bonded with resin. An economical solution for structural applications, substrates, and general construction where cost-efficiency is a priority.
              </p>
            ...
            <div className="relative aspect-square overflow-hidden rounded-lg">
              <Image
                src="/images/particle-board.jpg"
                alt="Particle board panels"
                fill
